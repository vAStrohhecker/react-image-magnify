...
function getPrimaryEnlargedImageContainerStyle(isInPlaceMode, isPortalRendered, orientation) {
    ...
    var position = orientation == _constants.ENLARGED_IMAGE_ORIENTATION.right ? {
        left: '100%',
        marginLeft: '10px',
    } : {
        right: '100%',
    ...
    return (0, _objectAssign2.default)(baseContainerStyle, sharedPositionStyle, position, {
...
function getEnlargedImageContainerStyle(params) {
    ...
    var containerDimensions = params.containerDimensions,
        ...
        enlargedImageOrientation = params.enlargedImageOrientation,
        isPortalRendered = params.isPortalRendered;


    var primaryStyle = getPrimaryEnlargedImageContainerStyle(isInPlaceMode, isPortalRendered, enlargedImageOrientation);
